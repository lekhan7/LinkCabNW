-- ============================================
-- LinkCab Supabase Database Schema
...
-- ============================================
-- PREFERRED TRAVEL PLACES (JSON array alternative)
-- ============================================
...
-- ============================================
-- PREFERRED LOCATIONS (JSON array alternative)
-- ============================================
...
-- ============================================
-- ANNOUNCEMENT PARTICIPANTS (joinedBy array alternative)
-- ============================================
...
-- ============================================
-- RIDE SHARED WITH (sharedWith array alternative)
-- ============================================
...
DECLARE
    settings_id UUID;
BEGIN
    SELECT id INTO settings_id FROM app_settings LIMIT 1;
    IF settings_id IS NULL THEN
        INSERT INTO app_settings DEFAULT VALUES RETURNING id INTO settings_id;
    END IF;
    RETURN settings_id;
END;
$$ LANGUAGE plpgsql;
...
-- Basic RLS policies (you may need to adjust these based on your auth strategy)
...
-- Similar policies would be needed for other tables based on your authentication requirements
...
INSERT INTO app_settings (id) VALUES (get_app_settings());
