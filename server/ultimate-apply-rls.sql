-- ================================================================
-- ULTIMATE CLEANUP AND APPLY COMPREHENSIVE RLS POLICIES
-- ================================================================
-- This script finds and drops ALL existing policies by querying system catalog
...
-- ================================================================
-- DROP ALL EXISTING POLICIES USING SYSTEM CATALOG
-- ================================================================

-- Create a function to drop all policies
    ...
    LOOP
        BEGIN
            EXECUTE format('DROP POLICY IF EXISTS %I ON %s', 
                       quote_ident(policy_record.policyname), 
...
-- Execute the function to drop all existing policies
...
-- Remove the cleanup function after use
