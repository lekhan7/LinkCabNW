-- ================================================================
-- FORCE CLEANUP AND APPLY COMPREHENSIVE RLS POLICIES
-- ================================================================
-- This script aggressively removes ALL policies including system ones, then applies new ones
...
-- Remove ALL policies from pg_policies table (system table)
DELETE FROM pg_policies WHERE tablename IN (
