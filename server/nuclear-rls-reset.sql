-- ================================================================
-- NUCLEAR RLS RESET - COMPLETE CLEAN SLATE APPROACH
-- ================================================================
-- This script completely resets RLS by removing all policies and starting fresh

-- Step 1: Remove ALL RLS policies from system catalog (nuclear option)
TRUNCATE pg_policies;
...
-- Step 3: Re-enable RLS on all tables (fresh start)
