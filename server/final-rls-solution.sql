-- ================================================================
-- FINAL RLS SOLUTION - BRUTE FORCE CLEANUP
-- ================================================================
-- This script completely resets RLS by disabling, clearing, then re-enabling

-- Step 1: Disable RLS on all tables to remove all policies
...
-- Step 2: Clear all policies from system catalog (brute force)
DO $$
DECLARE
