...
-- ================================================================
-- Admins can do ANYTHING on any table
-- Users have specific, restricted access based on table functionality
...
COMMENT ON VIEW admin_users IS 'Admin view of all users';
COMMENT ON VIEW admin_announcements IS 'Admin view of all announcements';
COMMENT ON VIEW admin_announcement_participants IS 'Admin view of all announcement participants';
COMMENT ON VIEW admin_notifications IS 'Admin view of all notifications';
COMMENT ON VIEW admin_ratings IS 'Admin view of all ratings';
COMMENT ON VIEW admin_reviews IS 'Admin view of all reviews';
COMMENT ON VIEW admin_favorite_routes IS 'Admin view of all favorite routes';
COMMENT ON VIEW admin_connection_requests IS 'Admin view of all connection requests';
COMMENT ON VIEW admin_payments IS 'Admin view of all payments';

-- Policy summary:
-- Admins: Full CRUD access to ALL tables
-- Users: Restricted access based on ownership and participation
-- Service Role: Access to OTPs for authentication operations
