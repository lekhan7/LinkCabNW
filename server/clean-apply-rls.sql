-- ================================================================
-- CLEAN AND APPLY COMPREHENSIVE RLS POLICIES
-- ================================================================
-- This script properly removes all existing policies then applies new ones
...
DROP POLICY IF EXISTS "Users delete announcements" ON announcements;
