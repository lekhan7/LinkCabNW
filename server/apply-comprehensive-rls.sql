-- ================================================================
-- CLEANUP AND APPLY COMPREHENSIVE RLS POLICIES
-- ================================================================
-- This script first removes ALL existing policies, then applies new comprehensive ones
...
DROP POLICY IF EXISTS "Users can view all announcements" ON users;
DROP POLICY IF EXISTS "Users create announcements" ON users;
DROP POLICY IF EXISTS "Users update own announcements" ON users;
DROP POLICY IF EXISTS "Users delete own announcements" ON users;
DROP POLICY IF EXISTS "Users delete announcements" ON users;
DROP POLICY IF EXISTS "Users view announcements" ON announcements;
...
DROP POLICY IF EXISTS "Users delete announcements with restrictions" ON announcements;
...
DROP POLICY IF EXISTS "Users view app settings" ON app_settings;

-- Preferred places policies
DROP POLICY IF EXISTS "Admin full access to preferred_travel_places" ON preferred_travel_places;
DROP POLICY IF EXISTS "Users manage own preferred travel places" ON preferred_travel_places;

-- Preferred locations policies
DROP POLICY IF EXISTS "Admin full access to preferred_locations" ON preferred_locations;
DROP POLICY IF EXISTS "Users manage own preferred locations" ON preferred_locations;

-- Announcement participants policies
DROP POLICY IF EXISTS "Admin full access to announcement_participants" ON announcement_participants;
DROP POLICY IF EXISTS "Users view announcement participants" ON announcement_participants;
DROP POLICY IF EXISTS "Users join announcements" ON announcement_participants;
DROP POLICY IF EXISTS "Users leave announcements" ON announcement_participants;
DROP POLICY IF EXISTS "Users update own participation" ON announcement_participants;

-- Announcement completion status policies
DROP POLICY IF EXISTS "Admin full access to announcement_completion_status" ON announcement_completion_status;
DROP POLICY IF EXISTS "Users manage own completion status" ON announcement_completion_status;

-- Rides policies
DROP POLICY IF EXISTS "Admin full access to rides" ON rides;
DROP POLICY IF EXISTS "Users manage own rides" ON rides;

-- Ride shares policies
DROP POLICY IF EXISTS "Admin full access to ride_shares" ON ride_shares;
DROP POLICY IF EXISTS "Users manage own ride shares" ON ride_shares;
...
-- Ratings policies
DROP POLICY IF EXISTS "Admin full access to ratings" ON ratings;
DROP POLICY IF EXISTS "Users view own ratings" ON ratings;
DROP POLICY IF EXISTS "Users create ratings" ON ratings;

-- Reviews policies
DROP POLICY IF EXISTS "Admin full access to reviews" ON reviews;
DROP POLICY IF EXISTS "Users view relevant reviews" ON reviews;
DROP POLICY IF EXISTS "Users create reviews" ON reviews;

-- Favorite routes policies
DROP POLICY IF EXISTS "Admin full access to favorite_routes" ON favorite_routes;
DROP POLICY IF EXISTS "Users manage own favorite routes" ON favorite_routes;

-- Connection requests policies
DROP POLICY IF EXISTS "Admin full access to connection_requests" ON connection_requests;
DROP POLICY IF EXISTS "Users manage own connection requests" ON connection_requests;

-- OTPs policies
DROP POLICY IF EXISTS "Admin full access to otps" ON otps;
DROP POLICY IF EXISTS "Service role access to otps" ON otps;
