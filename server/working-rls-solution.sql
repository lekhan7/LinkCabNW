-- ================================================================
-- WORKING RLS SOLUTION - CORRECT SYSTEM CATALOG APPROACH
-- ================================================================
-- This script properly removes all existing policies and applies new ones
...
-- Step 2: Drop any remaining policies using system catalog query
DO $$
DECLARE
    policy_name TEXT;
    table_name TEXT;
BEGIN
    FOR policy_name, table_name IN 
        SELECT policyname::TEXT, tablename::TEXT 
        FROM pg_policy 
        WHERE tablename IN (
