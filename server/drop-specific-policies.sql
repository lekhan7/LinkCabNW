-- ================================================================
-- DROP ALL SPECIFIC EXISTING POLICIES
-- ================================================================

-- Drop all the specific policies I can see in the users table
DROP POLICY IF EXISTS "Admins can delete users" ON users;
DROP POLICY IF EXISTS "Admins can update all users" ON users;
DROP POLICY IF EXISTS "Admins can view all users" ON users;
DROP POLICY IF EXISTS "Admins full control on users" ON users;
...
-- Disable RLS on users table to ensure clean state
...
-- ================================================================
-- USERS TABLE POLICIES (CLEAN VERSION)
-- ================================================================
...
-- ================================================================
-- NOW APPLY COMPREHENSIVE RLS TO ALL OTHER TABLES
-- ================================================================
